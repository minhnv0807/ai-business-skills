...
1. **What's your product / service?** (Industry, price tier, primary audience)
2. **Name 2-5 competitors you know** (brand names, page/TikTok/website links if available)
3. **What worries you most about competitors?** (Cheaper pricing? Better content? Stronger ads? Market share?)
4. **Goal after this report?** (Reposition? Improve content? Find market gap? Run ads more effectively?)
...
2. Filter by country + advertiser
3. Note: format mix (video/image/carousel), hooks used, CTAs, run duration
4. Compare against your ads -> find gaps and opportunities
...
- Need deeper customer understanding? -> Use `09-customer-insight-global`
- Want to reposition and write brief? -> Use `02-campaign-brief-global`
- Need differentiated copy? -> Use `05-ad-copy-global`
- Need competitive budget calculation? -> Use `10-reverse-kpi-global`
- Need full marketing plan? -> Use `00-marketing-plan-global`
- Dropshipping research? -> Use `29-dropshipping-mastery-global`
...
- [ ] Categorized competitors into 3 tiers (direct, indirect, secondary)
- [ ] Each competitor has all 8 analysis dimensions
- [ ] SWOT specific, not generic — each point names specific competitor
- [ ] Positioning map axes fit industry
- [ ] Found at least 3 market gaps
- [ ] Content benchmark has specific data (links, numbers), not vague observations
- [ ] "Learn vs Don't copy" section has specific actions
- [ ] Competitive moat assessed for both competitor and you
- [ ] Action table has timeline and urgency
- [ ] No unsupported claims — every conclusion has data or specific observation
