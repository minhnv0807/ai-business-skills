...
## Aspect ratio
1:1 (standard profile avatar for LinkedIn, Twitter, IG, podcast cover)

## Use case
Official profile photo for personal brand — LinkedIn headshot, Twitter avatar, IG profile, speaker bio photo.
...
## Cross-reference
See `references/personal-brand.md` for grill questions about role + values + brand archetype before drafting the prompt.
