...
license: MIT
triggers:
  - "cong dong personal brand"
  - "Zalo group"
  - "Skool community"
  - "Mighty Networks"
  - "fan club online"
  - "membership site"
  - "community building VN"
related:
...
```mermaid
graph TD
A[Audience persona?] --> B{Do tuoi}
B -->|18-25 tre VN| C{Niche}
B -->|26-40 trung VN| D{Free or Paid?}
B -->|>40 lon| E[Zalo Group]
C -->|Tech/Crypto/Game| F[Discord]
C -->|Mass content| G[FB Group]
D -->|Free community| H[FB Group + Zalo Group]
D -->|Paid premium| I{Co course?}
I -->|Yes co course| J[Skool hoac Mighty Networks]
I -->|No course| K[Zalo Group VIP + Telegram]
```
